...
proc pub:getReminders {nick host handle chan text} {
    ...
    if {$howMany < 1} {
	putserv "PRIVMSG $chan :Geen actieve herinneringen."
	return
    }

    # print reminders for this channel
    putserv "PRIVMSG $chan :$howMany actieve herinnering(en):"
...
proc pub:cancelReminder {nick host handle chan text} {
    ...
    putserv "PRIVMSG $chan :Herinnering: $text verwijdert"
...
proc pub:inspectReminders {nick host handle chan text} {
    ...
    putserv "NOTICE $nick :Herinneringen: $reminderString"
...
############################################
putlog "Reminder by ArNz|8o8 script loaded!"
############################################